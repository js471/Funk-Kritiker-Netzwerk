...
# Einleitung
Als junge Medienschaffende Person ist es zunächst äußerst reizvoll , sich einem jungen Medienformat wie Funk anzuschließen, anstatt zu den altbekannten und renommierten klassischen Medienhäusern in Deutschland zu gehen. Jedoch sind seit dem Start von Funk im Oktober 2016 mit bis dato über 40 Formaten, vermehrt Auffälligkeiten in der Öffentlichkeit aufgetreten, die einen zum Nachdenken über eine Bewerbung bei Funk anregen. Aus diesem Grund haben wir uns entschieden, das Netzwerk von Funk zu überprüfen, um herauszufinden, was hinter der aufkommenden Kritik steckt und woran es liegt, bzw. woher diese kommt. Gleichzeitig möchten wir visuell in einer Netzwerk- und Beziehungsanalyse darstellen, welche Zusammenhänge zwischen Funk und seinen Kritikern bestehen.
...
Forschungsfrage: Inwieweit hängen die Kanäle vom Funknetzwerk mit ihren Kritikern zusammen?
...
Die Netzwerkanalyse wird zeigen, dass sich Funk-Netzwerke und Kritiker von ARD und ZDF in zwei klare Cluster aufteilen. Innerhalb dieser Cluster werden einzelne Knoten als Brücken fungieren, und somit eine Verbindung zwischen den beiden Lagern herstellen. Diese Brücken-Knoten könnten Akteure oder Gruppen sein, die in beiden Netzwerken aktiv sind.
Homophilie, Indegree Werte aussschlaggebend?
